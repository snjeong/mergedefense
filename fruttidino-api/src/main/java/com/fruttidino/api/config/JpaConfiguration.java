...
@EnableJpaRepositories(basePackages = {"com.fruttidino.api"})
public class JpaConfiguration {
    ...
    public DataSource dataSource() {
        return ProxyDataSourceBuilder
                ...
                .name("SQL-Trace")
                .asJson()
                .logQueryBySlf4j(SLF4JLogLevel.TRACE, "com.fruttidino.SQL_TRACE")
//                .multiline()
                .build();
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.fruttidino.api");
